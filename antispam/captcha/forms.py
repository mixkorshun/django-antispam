...
class ReCAPTCHA(forms.Field):
    ...
    def __init__(self, sitekey=None, secretkey=None, timeout=None,
        ...
        :param pass_on_error: do not raise exception
                              if recaptcha service is not working.
        """
